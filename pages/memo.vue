<template>
    <section class="container">
        ...
        <table>
            <tr>
                <th>Title</th>
                <td><input type="text" name="title" class="title" v-model="title" size="40" @focus="set_flg">
                <button @click="find">find</button></td>
            </tr>
            <tr>
                <th>Memo</th>
                <td><textarea name="content" class="content" cols="50" v-model="content"></textarea></td>
            </tr>
            <tr>
                <th></th>
...
export default {
    ...
    computed:{
        ...
        page:{
           ...
           set:function() {
               var pg = p >
               (this.$sore.state/this.memo.memo.length -1) / this.num_per_page ?
